...
insert into plazas values(1,'71156437P','Miguel Delibes 8, Valladolid','camion',40.71727401, -74.00898606,'Plaza para camiones en las afueras de Valladolid', 'Parcial mañana', 20,'/Imagenes/plazas/parking1.jpg');
insert into plazas values(2,'71156437P','Plaza Zorrilla 6, Valladolid','moto',40.71727401, -74.00898606,'Plaza para moto', 'Parcial tarde',30,'/Imagenes/plazas/parking2.jpg');
insert into plazas values(3,'11159437S','Gran Via 2, Madrid','coche',40.71727401, -74.00898606,'Plaza situada en el centro de Madrid, imposible encontrar sitio por alrededor', 'Parcial mañana',40,'/Imagenes/plazas/parking3.jpg');
insert into plazas values(4,'11159437S','Plaza Mayor 4, Valladolid','coche',40.71727401, -74.00898606,'Plaza amplian en pleno centro', 'Jornada completa',40,'/Imagenes/plazas/parking4.jpg');
